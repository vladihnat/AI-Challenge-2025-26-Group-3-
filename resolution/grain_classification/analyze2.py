...
Produces three figures saved in group2_plots/:
  ...
  - conv2.png   : Training convergence (train_acc and val_acc per epoch)
"""
...
# --- import building blocks from group2_code2 ---
sys.path.insert(0, ".")
...
# -----------------------------------------------------------------------------
# 1) CONVERGENCE CURVE (train split only, internal val split)
# -----------------------------------------------------------------------------
...
# Map labels 1..8 -> 0..7 for convergence training
